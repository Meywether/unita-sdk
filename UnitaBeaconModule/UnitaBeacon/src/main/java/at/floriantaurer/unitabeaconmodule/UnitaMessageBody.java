...
public class UnitaMessageBody {
    private byte[] messageBodyRaw;

    /*package-private*/UnitaMessageBody(byte[] messageBodyRaw){
        this.messageBodyRaw = messageBodyRaw;
    }

    public byte[] getMessageBodyRaw() {
