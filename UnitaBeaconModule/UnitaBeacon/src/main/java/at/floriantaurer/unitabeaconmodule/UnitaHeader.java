...
public class UnitaHeader {
    private int headerMessageCode;
    private Peer sender;
    private Peer receiver;

    /*package-private*/UnitaHeader(int headerMessageCode, Peer sender, Peer receiver){
        this.sender = sender;
        this.receiver = receiver;
        this.headerMessageCode = headerMessageCode;
    }

    public int getHeaderMessageCode() {
