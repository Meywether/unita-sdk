...
public class CommandMessage extends UnitaMessage {

    public CommandMessage(Peer sender, Peer receiver, byte[] messageBodyRaw){
        super(2, sender, receiver, messageBodyRaw);
    }
