...
public class StatusMessage extends UnitaMessage {

    public StatusMessage(Peer sender, Peer receiver, byte[] messageBodyRaw){
        super(5, sender, receiver, messageBodyRaw);
    }
}
